...
class AssetTest(MarlinTestFramework):
    ...
    def big_test(self):
        ...
        n0.issue("MARLIN1", 1000)
        n0.issue("MARLIN2", 1000)
        n0.issue("MARLIN3", 1000)
        n0.generate(1)
        self.sync_all()

        n0.listassets(asset="MARLIN*", verbose=False, count=2, start=-2)
        ...
        marlin_assets = n0.listassets(asset="MARLIN*", verbose=False, count=2, start=-2)
        assert_equal(len(marlin_assets), 2)
        assert_equal(marlin_assets[0], "MARLIN2")
        assert_equal(marlin_assets[1], "MARLIN3")
        self.sync_all()
