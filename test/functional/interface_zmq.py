...
from test_framework.test_framework import MarlinTestFramework, SkipTest
...
class ZMQTest (MarlinTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that marlin has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("marlind has not been built with zmq enabled.")
