...
class TestMarlinCli(MarlinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `marlin-cli getinfo`")
        ...
        self.log.info("Compare responses from `marlin-cli -getinfo` and the RPCs data is retrieved from.")
