...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the MarlinTestFramework
    pass

class ExampleTest(MarlinTestFramework):
    # Each functional test is a subclass of the MarlinTestFramework class.
    ...
    def custom_method(self):
        ...
        MarlinTestFramework class so other tests can use it."""
