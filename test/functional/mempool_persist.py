...
By default, marlind will dump mempool on shutdown and
...
class MempoolPersistTest(MarlinTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give marlind a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent marlind from writing mempool.dat to disk. Verify that `savemempool` fails")
