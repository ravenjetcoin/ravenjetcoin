...
# TestNode: A peer we use to send messages to marlind, and store responses.
...
class CompactBlocksTest(MarlinTestFramework):
    ...
    # This test actually causes marlind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that marlind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for marlind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # marlind will not send blocktxn responses for blocks whose height is
