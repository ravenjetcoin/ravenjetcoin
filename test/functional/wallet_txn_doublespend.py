...
class TxnMallTest(MarlinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 MRL:
        ...
        # First: use raw transaction API to send 1240 MRL to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 MRL coin each
        ...
        # Node0's balance should be starting balance, plus 50MRL for another
        ...
        # Node0's total balance should be starting balance, plus 100MRL for 
