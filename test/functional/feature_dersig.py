...
class BIP66Test(MarlinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # marlind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and marlind produces more specific reject
            # reasons.
