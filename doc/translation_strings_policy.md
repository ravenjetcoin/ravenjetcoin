...
This document provides guidelines for internationalization of the Marlin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `marlin_en.ts` remains unchanged.
