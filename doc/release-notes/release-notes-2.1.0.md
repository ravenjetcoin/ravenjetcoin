Marlin Core version *2.1.0* is now available!!
==============

  <https://github.com/MarlinProject/Marlincoin/releases/tag/v2.1.0>
...
Please report bugs using the issue tracker at GitHub:
  ...
  <https://github.com/MarlinProject/Marlincoin/issues>

To receive security and update notifications, please subscribe to:

  <https://marlincoin.org/en/list/announcements/join/>
...
installer (on Windows) or just copy over `/Applications/Marlin-Qt` (on Mac)
or `marlind`/`marlin-qt` (on Linux).
...
Marlin Core is extensively tested on multiple operating systems using
the Linux kernel, macOS 10.8+, and Windows Vista and later. 32-bit versions of Windows,
and Windows XP are not supported.

Marlin Core should also work on most other Unix-like systems but is not
frequently tested on them.

Marlin Core has been tested with macOS 10.14 Mojave, but it is recommended that developers
...
Changelog available here: <https://github.com/MarlinProject/Marlincoin/commits/release_2.1.0>
...
- Most importantly - The Marlin Community!
- Tron Black
- Jesse Empey
- Jeremy Anderson
- Corbin Fox
