...
#ifndef MARLIN_TEST_SCRIPTNUM10_H
#define MARLIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Marlin Core 0.10.0, for cross-comparison.
 */
public:
