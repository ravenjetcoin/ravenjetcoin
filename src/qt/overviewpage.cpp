...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(MarlinUnits::MRL),
    ...
    assetdelegate(new AssetViewDelegate(platformStyle, this))
{
    ...
    ui->mrlBalancesLabel->setStyleSheet(STRING_LABEL_COLOR);
    ...
    ui->mrlBalancesLabel->setFont(GUIUtil::getTopLabelFont());
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(MarlinUnits::formatWithUnit(unit, balance, false, MarlinUnits::separatorAlways));
    ui->labelUnconfirmed->setText(MarlinUnits::formatWithUnit(unit, unconfirmedBalance, false, MarlinUnits::separatorAlways));
    ui->labelImmature->setText(MarlinUnits::formatWithUnit(unit, immatureBalance, false, MarlinUnits::separatorAlways));
    ui->labelTotal->setText(MarlinUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, MarlinUnits::separatorAlways));
    ui->labelWatchAvailable->setText(MarlinUnits::formatWithUnit(unit, watchOnlyBalance, false, MarlinUnits::separatorAlways));
    ui->labelWatchPending->setText(MarlinUnits::formatWithUnit(unit, watchUnconfBalance, false, MarlinUnits::separatorAlways));
    ui->labelWatchImmature->setText(MarlinUnits::formatWithUnit(unit, watchImmatureBalance, false, MarlinUnits::separatorAlways));
    ui->labelWatchTotal->setText(MarlinUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, MarlinUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("MRL")
    updateDisplayUnit();
}
...
void OverviewPage::showAssets()
{
    if (AreAssetsDeployed()) {
        ...
        // This keeps the MRL balance grid from expanding and looking terrible when asset balance is hidden
