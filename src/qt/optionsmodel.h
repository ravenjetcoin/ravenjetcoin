...
#ifndef MARLIN_QT_OPTIONSMODEL_H
#define MARLIN_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Marlin client.
...
#endif // MARLIN_QT_OPTIONSMODEL_H
