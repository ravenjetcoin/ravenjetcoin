...
#include "qt/marlinamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<MarlinAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_marlin-qt -platform xcb      # Linux
//     src/qt/test/test_marlin-qt -platform windows  # Windows
//     src/qt/test/test_marlin-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = MarlinUnits::formatWithUnit(unit, balance, false, MarlinUnits::separatorAlways);
    ...
    // Amount input
    MarlinAmountField* amountInput = receiveCoinsDialog.findChild<MarlinAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: marlin:")) != -1);
