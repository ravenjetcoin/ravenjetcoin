...
#ifndef MARLIN_QT_GUIUTIL_H
#define MARLIN_QT_GUIUTIL_H
...
/** Utility functions used by the Marlin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "marlin:" URI into recipient object, return true on successful parsing
