...
#ifndef MARLIN_QT_MARLINGUI_H
#define MARLIN_QT_MARLINGUI_H
...
/**
  Marlin GUI main class. This class represents the main window of the Marlin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class MarlinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit MarlinGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~MarlinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a marlin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
