...
#ifndef MARLIN_QT_MARLINUNITS_H
#define MARLIN_QT_MARLINUNITS_H
...
/** Marlin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class MarlinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit MarlinUnits(QObject *parent);

    /** Marlin units.
      @note Source: https://en.marlin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        MRL,
...
typedef MarlinUnits::Unit MarlinUnit;

#endif // MARLIN_QT_MARLINUNITS_H
