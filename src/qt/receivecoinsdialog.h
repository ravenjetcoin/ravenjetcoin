...
#ifndef MARLIN_QT_RECEIVECOINSDIALOG_H
#define MARLIN_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of marlins */
...
#endif // MARLIN_QT_RECEIVECOINSDIALOG_H
