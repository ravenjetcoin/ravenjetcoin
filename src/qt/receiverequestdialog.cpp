...
#include "config/marlin-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatMarlinURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + MarlinUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatMarlinURI(info));
}
