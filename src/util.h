 ...
 */
#ifndef MARLIN_UTIL_H
#define MARLIN_UTIL_H
...
extern const char *const MARLIN_CONF_FILENAME;
extern const char *const MARLIN_PID_FILENAME;
...
{
    std::string s = strprintf("marlin-%s", name);
