...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1547306472, 4928333, 0x1e00ffff, 4, 5000 * COIN);
...
//        /////////////////////////////////////////////////////////////////
        ...
        vSeeds.emplace_back("seed-testnet-marlin.bitactivate.com", false);
        vSeeds.emplace_back("seed-testnet-marlin.marlincoin.com", false);
        vSeeds.emplace_back("seed-testnet-marlin.marlincoin.org", false);
