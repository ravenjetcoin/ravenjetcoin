#!/usr/bin/env python3
# Script to issue assets on the Marlincoin platform
...
# Prerequisite: marlind daemon to be running
...
#Set this to your marlin-cli program
cli = "marlin-cli"
...
#Set this information in your marlin.conf file (in datadir, not testnet3)
rpc_user = 'rpcuser'
rpc_pass = 'rpcpass555'
