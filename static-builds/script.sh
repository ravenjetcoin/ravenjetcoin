...
find ${DISTNAME}/bin -type f -executable -exec ../marlincoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../marlincoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/marlincoin/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/marlincoin/depends/SDKs/MacOSX10.11.sdk.tar.gz
